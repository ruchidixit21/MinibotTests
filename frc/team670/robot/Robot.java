...
//  private Command autonomousCommand, operatorControl;
  ...
  public void robotInit() {
    ...
    Scheduler.getInstance().add(new PIDDistanceDrive(30));
    //Scheduler.getInstance().add(new PIDDistanceDrive(-60));

    //Scheduler.getInstance().add(new DistanceDrive(30, 1.0, 1.0));
  }
